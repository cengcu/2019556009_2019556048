...
import cu.meha.cars.service.UserCarService;
...
public class CarController {
  ...
  public String listCarsSortedByPriceAsc(Model model) {
    List<Car> sortedCars = carService.findAllByOrderByPriceAsc();
    model.addAttribute("listCar", sortedCars);
    return "cars";
  }

  @GetMapping("/sortByPriceDesc")
  public String listCarsSortedByPriceDesc(Model model) {
    List<Car> sortedCars = carService.findAllByOrderByPriceDesc();
    model.addAttribute("listCar", sortedCars);
    return "cars";
  }
