        ...
        <div class="container d-flex justify-content-center align-items-center">
          <div class="jumbotron-content pt-4">
            ...
            <div class="jumbotron-text">
              <h2 class="fw-bolder m-0">Everything You Are Looking</h2>
              <h2 class="fw-bolder">For About the Car</h2>
              <p>A reliable point that brings together sellers and buyers</p>
            </div>
