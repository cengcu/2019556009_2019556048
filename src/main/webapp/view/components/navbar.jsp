<nav class="navbar navbar-expand-lg sticky-top p-0">
  <div class="container">
    <a class="navbar-brand fw-bold fs-5" href="<%= request.getContextPath() %>/"> <img src="/images/car/logo-son.png"height="100px" weight="100px" > </a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <security:authorize access="!isAuthenticated()">
        <div class="nav-button d-flex flex-column flex-lg-row">
          ...
          <a href="<%= request.getContextPath() %>/register" class="btn btn-danger mb-3 mb-lg-0">Register</a>
        </div>
      </security:authorize>
