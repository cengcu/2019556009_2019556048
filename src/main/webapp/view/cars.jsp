            ...
            <ul class="fw-semibold">
              ...
              <li>
                <a href="<%= request.getContextPath() %>/user/post-car">
                  <button class="btn btn-danger">Post a car</button>
                </a>
              </li>
              <li>
              ...
              <li class="dropdown">
                                <p class="ms-1 dropdown-toggle" id="dropdownMenuButton" data-bs-toggle="dropdown"
                                   aria-expanded="false"><i class="fa-solid fa-dollar-sign"></i> Sort by Price</p>
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <li><a class="dropdown-item"
                                           href="<%= request.getContextPath() %>/cars/sortByPriceAsc">Ascending</a></li>
                                    <li><a class="dropdown-item"
                                           href="<%= request.getContextPath() %>/cars/sortByPriceDesc">Descending</a></li>
                                </ul>
                            </li>
            </ul>
          </aside>
                      ...
                      <div class="card">
                        ...
                        <div class="card-body">
                          ...
                          <a href="<%= request.getContextPath() %>/cars/${car.make}/${car.model}/${car.year}/${car.idCar}">
                            <button class="btn btn-dark">Car Details</button>
                          </a>
                        </div>
                      </div>
                    </div>
